...
async function run() {
    ...
    for (const d of snap.docs) {
        ...
        const timeMatch = (data.slot === '15:00' || data.time === '15:00'); // Check both field names
        
        console.log(`Checking Doc ID: ${d.id} | Price: ${data.price} | Date: ${data.date} | Slot/Time: ${data.slot || data.time}`);
