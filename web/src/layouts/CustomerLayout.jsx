            ...
            <header className="h-16 border-b border-indigo-100 bg-white/70 backdrop-blur-xl sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 h-full flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        ...
                        <Link to="/customer/app" className="text-sm font-bold text-gray-500 hover:text-indigo-600 transition-colors">All Services</Link>

                        {currentUser ? (
                            <div className="flex items-center gap-6 ml-4 border-l border-gray-200 pl-6">
                                <Link to="/customer/app" className="text-sm font-bold text-indigo-600 bg-indigo-50 px-4 py-2 rounded-full hover:bg-indigo-100 transition-colors">My Dashboard</Link>
                                <Link to="/customer/profile" className="text-sm font-bold text-gray-600 hover:text-indigo-600 transition-colors">My Profile</Link>
                            ...
                            <div className="flex items-center gap-4 ml-4 border-l border-gray-200 pl-6">
                                ...
                                <Link to="/customer/login" className="px-6 py-2.5 text-sm font-bold text-white bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full hover:from-blue-700 hover:to-indigo-700 transition-all shadow-md shadow-indigo-600/20 hover:shadow-lg hover:-translate-y-0.5">
                                    Sign In
                                </Link>
                            </div>
                        )}
